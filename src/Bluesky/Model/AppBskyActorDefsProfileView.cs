...
namespace Bluesky.Model
{
    ...
    public partial class AppBskyActorDefsProfileView
    {
        /// <summary>
        ...
        public AppBskyActorDefsProfileView(string did = default(string), string handle = default(string), string displayName = default(string), string description = default(string), string avatar = default(string), DateTime indexedAt = default(DateTime), AppBskyActorDefsViewerState viewer = default(AppBskyActorDefsViewerState), List<ComAtprotoLabelDefsLabel> labels = default(List<ComAtprotoLabelDefsLabel>))
        {
