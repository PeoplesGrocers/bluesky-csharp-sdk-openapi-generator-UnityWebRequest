...
{
    /// <summary>
    /// ComAtprotoAdminDefsSubjectStatusView
    /// </summary>
    [DataContract(Name = "com.atproto.admin.defs.subjectStatusView")]
    public partial class ComAtprotoAdminDefsSubjectStatusView
    {
        ...
        public ComAtprotoAdminDefsSubjectReviewState ReviewState { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="ComAtprotoAdminDefsSubjectStatusView" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ComAtprotoAdminDefsSubjectStatusView() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ComAtprotoAdminDefsSubjectStatusView" /> class.
        /// </summary>
        ...
        public ComAtprotoAdminDefsSubjectStatusView(int id = default(int), ComAtprotoAdminEmitModerationEventRequestSubject subject = default(ComAtprotoAdminEmitModerationEventRequestSubject), List<string> subjectBlobCids = default(List<string>), string subjectRepoHandle = default(string), DateTime updatedAt = default(DateTime), DateTime createdAt = default(DateTime), ComAtprotoAdminDefsSubjectReviewState reviewState = default(ComAtprotoAdminDefsSubjectReviewState), string comment = default(string), DateTime muteUntil = default(DateTime), string lastReviewedBy = default(string), DateTime lastReviewedAt = default(DateTime), DateTime lastReportedAt = default(DateTime), DateTime lastAppealedAt = default(DateTime), bool takendown = default(bool), bool appealed = default(bool), DateTime suspendUntil = default(DateTime), List<string> tags = default(List<string>))
        {
            this.Id = id;
            // to ensure "subject" is required (not null)
            if (subject == null)
            {
                throw new ArgumentNullException("subject is a required property for ComAtprotoAdminDefsSubjectStatusView and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ComAtprotoAdminDefsSubjectStatusView {\n");
