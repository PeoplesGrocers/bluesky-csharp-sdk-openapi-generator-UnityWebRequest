...
namespace Bluesky.Model
{
    ...
    public partial class ComAtprotoServerListAppPasswordsAppPassword
    {
        /// <summary>
        ...
        public ComAtprotoServerListAppPasswordsAppPassword(string name = default(string), DateTime createdAt = default(DateTime))
        {
