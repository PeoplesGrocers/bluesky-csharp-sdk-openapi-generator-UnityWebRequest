...
namespace Bluesky.Model
{
    ...
    public partial class ComAtprotoRepoPutRecordRequest
    {
        /// <summary>
        ...
        public ComAtprotoRepoPutRecordRequest(string repo = default(string), string collection = default(string), string rkey = default(string), bool validate = true, Object record = default(Object), string swapRecord = default(string), string swapCommit = default(string))
        {
