...
namespace Bluesky.Model
{
    ...
    public partial class ComAtprotoIdentitySignPlcOperationRequest
    {
        /// <summary>
        ...
        public ComAtprotoIdentitySignPlcOperationRequest(string token = default(string), List<string> rotationKeys = default(List<string>), Object alsoKnownAs = default(Object), Object verificationMethods = default(Object), Object services = default(Object))
        {
            this.Token = token;
