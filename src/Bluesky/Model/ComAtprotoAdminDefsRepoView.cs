...
namespace Bluesky.Model
{
    ...
    /// </summary>
    [DataContract(Name = "com.atproto.admin.defs.repoView")]
    public partial class ComAtprotoAdminDefsRepoView
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComAtprotoAdminDefsRepoView" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ComAtprotoAdminDefsRepoView() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ComAtprotoAdminDefsRepoView" /> class.
        /// </summary>
        ...
        public ComAtprotoAdminDefsRepoView(string did = default(string), string handle = default(string), string email = default(string), List<Object> relatedRecords = default(List<Object>), DateTime indexedAt = default(DateTime), ComAtprotoAdminDefsModeration moderation = default(ComAtprotoAdminDefsModeration), ComAtprotoServerDefsInviteCode invitedBy = default(ComAtprotoServerDefsInviteCode), bool invitesDisabled = default(bool), string inviteNote = default(string))
        {
            // to ensure "did" is required (not null)
            if (did == null)
            {
                throw new ArgumentNullException("did is a required property for ComAtprotoAdminDefsRepoView and cannot be null");
            }
            this.Did = did;
            // to ensure "handle" is required (not null)
            if (handle == null)
            {
                throw new ArgumentNullException("handle is a required property for ComAtprotoAdminDefsRepoView and cannot be null");
            }
            this.Handle = handle;
            // to ensure "relatedRecords" is required (not null)
            if (relatedRecords == null)
            {
                throw new ArgumentNullException("relatedRecords is a required property for ComAtprotoAdminDefsRepoView and cannot be null");
            }
            ...
            if (moderation == null)
            {
                throw new ArgumentNullException("moderation is a required property for ComAtprotoAdminDefsRepoView and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ComAtprotoAdminDefsRepoView {\n");
