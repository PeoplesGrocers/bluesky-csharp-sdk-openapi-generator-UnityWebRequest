...
namespace Bluesky.Model
{
    ...
    public partial class ComAtprotoAdminDefsAccountView
    {
        /// <summary>
        ...
        public ComAtprotoAdminDefsAccountView(string did = default(string), string handle = default(string), string email = default(string), List<Object> relatedRecords = default(List<Object>), DateTime indexedAt = default(DateTime), ComAtprotoServerDefsInviteCode invitedBy = default(ComAtprotoServerDefsInviteCode), List<ComAtprotoServerDefsInviteCode> invites = default(List<ComAtprotoServerDefsInviteCode>), bool invitesDisabled = default(bool), DateTime emailConfirmedAt = default(DateTime), string inviteNote = default(string))
        {
