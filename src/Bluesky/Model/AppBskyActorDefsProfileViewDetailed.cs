...
namespace Bluesky.Model
{
    ...
    public partial class AppBskyActorDefsProfileViewDetailed
    {
        /// <summary>
        ...
        public AppBskyActorDefsProfileViewDetailed(string did = default(string), string handle = default(string), string displayName = default(string), string description = default(string), string avatar = default(string), string banner = default(string), int followersCount = default(int), int followsCount = default(int), int postsCount = default(int), DateTime indexedAt = default(DateTime), AppBskyActorDefsViewerState viewer = default(AppBskyActorDefsViewerState), List<ComAtprotoLabelDefsLabel> labels = default(List<ComAtprotoLabelDefsLabel>))
        {
