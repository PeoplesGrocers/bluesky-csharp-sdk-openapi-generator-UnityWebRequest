...
namespace Bluesky.Model
{
    ...
    public partial class ComAtprotoServerCreateAppPasswordAppPassword
    {
        /// <summary>
        ...
        public ComAtprotoServerCreateAppPasswordAppPassword(string name = default(string), string password = default(string), DateTime createdAt = default(DateTime))
        {
