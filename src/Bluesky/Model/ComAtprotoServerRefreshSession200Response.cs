...
namespace Bluesky.Model
{
    ...
    public partial class ComAtprotoServerRefreshSession200Response
    {
        /// <summary>
        ...
        public ComAtprotoServerRefreshSession200Response(string accessJwt = default(string), string refreshJwt = default(string), string handle = default(string), string did = default(string), Object didDoc = default(Object))
        {
