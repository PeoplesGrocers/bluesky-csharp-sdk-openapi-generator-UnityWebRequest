...
namespace Bluesky.Model
{
    ...
    public partial class AppBskyEmbedRecordViewRecordEmbedsInner : AbstractOpenAPISchema
    {
        /// <summary>
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                ...
                else if (value.GetType() == typeof(AppBskyEmbedRecordView))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(AppBskyEmbedRecordWithMediaView))
                {
                    this._actualInstance = value;
                }
                else
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: AppBskyEmbedExternalView, AppBskyEmbedImagesView, AppBskyEmbedRecordView, AppBskyEmbedRecordWithMediaView");
                }
            }
        }
