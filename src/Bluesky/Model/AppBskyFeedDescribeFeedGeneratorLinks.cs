...
namespace Bluesky.Model
{
    ...
    /// </summary>
    [DataContract(Name = "app.bsky.feed.describeFeedGenerator.links")]
    public partial class AppBskyFeedDescribeFeedGeneratorLinks
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AppBskyFeedDescribeFeedGeneratorLinks" /> class.
        /// </summary>
        /// <param name="privacyPolicy">privacyPolicy.</param>
        /// <param name="termsOfService">termsOfService.</param>
        public AppBskyFeedDescribeFeedGeneratorLinks(string privacyPolicy = default(string), string termsOfService = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AppBskyFeedDescribeFeedGeneratorLinks {\n");
