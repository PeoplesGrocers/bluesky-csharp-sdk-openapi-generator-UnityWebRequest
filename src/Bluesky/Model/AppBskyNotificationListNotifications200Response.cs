...
namespace Bluesky.Model
{
    ...
    public partial class AppBskyNotificationListNotifications200Response
    {
        /// <summary>
        ...
        public AppBskyNotificationListNotifications200Response(string cursor = default(string), List<AppBskyNotificationListNotificationsNotification> notifications = default(List<AppBskyNotificationListNotificationsNotification>), DateTime seenAt = default(DateTime))
        {
