...
namespace Bluesky.Model
{
    ...
    public partial class AppBskyActorDefsFeedViewPref
    {
        /// <summary>
        ...
        public AppBskyActorDefsFeedViewPref(string feed = default(string), bool hideReplies = default(bool), bool hideRepliesByUnfollowed = default(bool), int hideRepliesByLikeCount = default(int), bool hideReposts = default(bool), bool hideQuotePosts = default(bool))
        {
